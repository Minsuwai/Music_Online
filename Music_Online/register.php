          ...
          <div class="row container-fluid">
            <div class="container-fluid col-md-1">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="#"><button class="btn btn-outline-primary"> Login </button> </a>
                </li>
              </ul>
            </div>
            <div class="container-fluid col-md-6">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="#"><button class="btn btn-outline-primary"> Register </button> </a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row login_row no-gutters ">
          ...
          <div class="col-lg-7">
            ...
            <form>
              ...
              <div class="form-row mt-2">
                <div class="col-lg-7">
                  <input type="password" name="" placeholder="Repeat password" class="form-control">
                </div>
              </div>
              <div class="form-row mt-2">
                <div class="col-lg-7">
              ...
              <div class="form-row mt-2 ">
                <div class="col-lg-7 ">
                  <button type="button" class="btn btn-outline-primary mb-4">Login</button>
                </div>
              </div>

              <a href="#" class="text-primary login_btn">Forgot Password?</a>
              <p style="color: dark;">Already have an account? <a href="#" class="text-primary login_btn">Login</a></p>
            </form>
          </div>
        </div>
      </div>
